...
/**
 * Event класс события queue_item_requeued.
 *
 ...
 * }
 */
class queue_item_requeued extends \core\event\base {
    ...
    public function get_description() {
        return sprintf(
            'Элемент очереди %s для xAPI выражения с id #%d был вовзвращён в очередь. Error: %s',
            $this->other['queue'],
            $this->other['objectid'],
            $this->other['error']
        );
